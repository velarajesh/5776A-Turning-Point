...
ObjRenderer::ObjRenderer(lv_obj_t *iparent, ObjContainer *ioContainer) : parent(iparent), wScale((double)lv_obj_get_width(parent) / VISION_FOV_WIDTH), hScale((double)lv_obj_get_height(parent) / VISION_FOV_HEIGHT),
